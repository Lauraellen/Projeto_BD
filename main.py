...
while(menu):
    ...
    if(value1 == 1):
        ...
        if(value2 == 1):
            ...
            cartaoDoSus = int(input("Informe seu cartão do SUS: "))
            cpf = int(input("Por último, digite o cpf do paciente: "))
            ...
            nome = input("Informe o nome do paciente: ")
            cpf = int(input("Agora informe o CPF a ser atualizado no sistema: "))
            ...
            lote = int(input("Digite o número lote da vacina recebida pelo paciente: "))
            ...
            numIdent = int(input("Digite o número de identificação do PSF: "))
        ...
        if (value4 == 1):
            ...
            fundacao = int(input("Por último, informe o ano de fundação da empresa fabricante: "))
        ...
        if (value5 == 1):
            numIdent = int(input("Informe o número de identificação do PSF: "))
